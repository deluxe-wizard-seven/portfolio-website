  ...
  const experiences = [
    {
      ...
      achievements: [
        "Led backend system architecture & cloud infrastructure (AWS & GCP) for a production app delivering 10+ core features with 99.9% uptime",
        "Architected modular microservices with event-driven design, asynchronous task execution & efficient inter-service communication - improving system reliability & cutting API response latency by 56%",
        "Designed & implemented Google OAuth 2.0, Apple SSO & Facebook SSO for secure authentication, boosting user onboarding by 47%",
        "Developed a full-scale subscription management system using Stripe APIs with trials & webhooks, ensuring seamless billing & compliance",
        "Automated deployments with CI/CD pipelines (GitHub Actions, Docker, Cloud Build) enabling zero-downtime releases & 70% faster release cycles, & 95% reduction in manual deployment errors",
        "Migrated ML inference workloads from AWS EC2 to ECS, reducing compute overhead & cutting infrastructure costs by 40%",
        "Engineered real-time collaboration architecture using Socket.IO, Redis Pub/Sub & WebSockets, scaling from MVP to 1,000+ concurrent sessions with low latency & high reliability",
        "Developed LiveKit-based AI Voice Agent system supporting multi-user audio rooms with live transcription & recording, designed for fault-tolerant, scalable real-time collaboration",
        "Revamped audio processing pipelines, implementing asynchronous task handling & caching, increasing processing throughput by 66.7%",
        "Streamlined PostgreSQL & NoSQL databases (Redis, DynamoDB, Firestore), reducing storage footprint by 35% & latency by 50%",
        "Resolved 100+ critical backend production issues, improving system stability, uptime & reducing average incident response time by 50%",
      ],
